...
import { useCreatePurchasePayment } from "@/lib/hooks/use-purchases";
...
export function PurchasePaymentForm({ trigger }: { trigger: React.ReactNode }) {
  ...
  async function onSubmit(values: PaymentFormValues) {
    try {
      ...
      form.reset({ entry_date: values.entry_date, supplier_id: "", amount: 0, mode: "cash" });
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>New purchase payment</DialogTitle>
        </DialogHeader>
        <Form {...form}>
